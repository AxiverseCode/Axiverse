...
namespace Axiverse.Services.Proto {
  public static partial class AssetService
  {
    ...
    {
      serviceBinder.AddMethod(__Method_CreateAssetClass, serviceImpl.CreateAssetClass);
      serviceBinder.AddMethod(__Method_DeleteAssetClass, serviceImpl.DeleteAssetClass);
      serviceBinder.AddMethod(__Method_CreateAsset, serviceImpl.CreateAsset);
      serviceBinder.AddMethod(__Method_DeleteAsset, serviceImpl.DeleteAsset);
      serviceBinder.AddMethod(__Method_TransferAsset, serviceImpl.TransferAsset);
      serviceBinder.AddMethod(__Method_ExecuteTransaction, serviceImpl.ExecuteTransaction);
    }
